...
app.run(function($ionicPlatform,$cordovaBeacon,$window,clearAppDataCache,$cordovaSQLite,$cordovaLocalNotification,backgroundMode){
  ...
  $ionicPlatform.ready(function(){
        ...
        */
        ...
        $cordovaSQLite.execute(db,"CREATE TABLE IF NOT EXISTS konnekt_table (id integer primary key , title  text , text text , url text , icons text , content text , fulldate_detected text , date_detected text , unique_id text)")
        .then(function(res){
