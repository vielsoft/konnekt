...
app.run(function($ionicPopup,$ionicPlatform,$cordovaBeacon,$window,clearAppDataCache,$cordovaSQLite,$cordovaLocalNotification,backgroundMode){
  ...
  $ionicPlatform.ready(function(){
        ...
        $cordovaSQLite.execute(db,"CREATE TABLE IF NOT EXISTS konnekt_table (id text primary key , title  text , text text , url text , icons text , content text , fulldate_detected date , date_detected text)")
        .then(function(res){
